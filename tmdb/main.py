...
descripcion = '''
Ingeniería de Datos: Caso uso wrapper Public API The Movie Database

TMDB [Link](https://developer.themoviedb.org/docs/getting-started)
'''

@asynccontextmanager
async def lifespan(app: FastAPI):    
    log.info(f"{settings.app_name} started with API_KEY [{settings.api_key}]")
    yield
    ...
    openapi_tags= [   
                    {
                        ...
                        "description": "Wrapper de The Movie Database Public API"                        
                    }                     
                ],
    lifespan=lifespan
)
